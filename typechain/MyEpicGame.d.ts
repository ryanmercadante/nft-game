...
interface MyEpicGameInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "AttackCompleted(uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "AttackCompleted"): EventFragment;
...
export type AttackCompletedEvent = TypedEvent<
...
export class MyEpicGame extends BaseContract {
  ...
  filters: {
    ...
    "AttackCompleted(uint256,uint256)"(
      newBossHp?: null,
      newPlayerHp?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
